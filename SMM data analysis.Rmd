...
Referencia: Informe  del 9 al 16 de marzo
...
total_Playlist_starts <-
  ...
  ggplot(aes(xDate, y=playlist_starts)) +
  geom_line() +
  geom_point() +
...
ggplot(total_impressions) +
  ...
  geom_point(aes(x=Date, y=playlist_starts)) +
  ggtitle("playlist starts") +
  ylab("total playlist starts")
