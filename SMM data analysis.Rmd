...
```{r}
table_data <- read_sheet("https://docs.google.com/spreadsheets/d/1iv_7lBeondfTiLN_kLRnAW-9UnmT4lw6RVQxCuSD0vY/edit#gid=1622987274", sheet = "Table data")

chart_data <- read_sheet("https://docs.google.com/spreadsheets/d/17eqGaU2VtBkbn1kMFa_YgvUosW-1XR9M-oztZZcUmTc/edit#gid=1209667660", sheet = "Chart data")

totals <- read_sheet("https://docs.google.com/spreadsheets/d/1iv_7lBeondfTiLN_kLRnAW-9UnmT4lw6RVQxCuSD0vY/edit#gid=1622987274", sheet = "Totals")
```
4/1AX4XfWiwUijq9sdSf71im5MXLb90ZebZPuKHHcrwfDSxPuG9MwbN64J2gbU

```{r}
totals %>% 
  select(Date, Views_Y) %>% 
  ggplot(aes(x = Date, y = Views_Y, group = 1)) +
  geom_line() +
  ggtitle("Total views per day ") +
  ylab("Total Views")
